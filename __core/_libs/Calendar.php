...
class Calendar {
    ...
    ##############################
    #农历天干
    public $mten = array('null', '甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸');    #农历地支
    public $mtwelve = array('null', '子(鼠)', '丑(牛)', '寅(虎)', '卯(兔)', '辰(龙)',
        '巳(蛇)', '午(马)', '未(羊)', '申(猴)', '酉(鸡)', '戌(狗)', '亥(猪)');    #农历月份
    public $mmonth = array('闰', '正', '二', '三', '四', '五', '六',
        '七', '八', '九', '十', '十一', '十二', '月');
    public $mday = array('null', '初一', '初二', '初三', '初四', '初五', '初六', '初七', '初八', '初九', '初十',
    ...
    public $mweek = array('日', '一', '二', '三', '四', '五', '六'); #星期
    ...
    function Cal($Year, $Month, $Day) {
        ...
        return ['year' => $this->mten[$this->everyCMonth[$Par['m']][14]] . $this->mtwelve[$this->everyCMonth[$Par['m']][15]],
            'month' => $cMonth,
            'day' => $this->mday[$md],
