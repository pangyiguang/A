...
<html>
    <head>
        ...
        <style type="text/css">
            body{font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;font-size: 14px;line-height: 1.8em;width: 100%;text-align: center;background-color: #f0fcff;padding-top: 20px;color:#292D2F}
            a{color:#F0C040;text-decoration:none}
            h3{font-size: 18px;color: #F0C040}
        </style>
    </head>
    <body>
        <div class="container">
